# -*- coding: utf-8-*-
from Selesai.linepy import *
from Selesai.akad import *
from Selesai.linepy.style import *
from Selesai.linepy.login import *
from selesai import selesai
...
"""
                    ...
                    BOT TYPE      -  SELESAI SELFBOT
                    DEVELOPER     -  SELESAICOMMUNITY.COM/TEAM
                    SOURCE LIB    -  PYPI/LINEPY
                    MEDIA API     -  PYPI/SELESAI
                    PUBLISHED     -  GITHUB.COM/SELESAICOM/MINI-SELFBOTV2
"""
...
media = imjustgood(setting["selesai"])
host = "https://{}".format(setting["api.selesai.com"])
